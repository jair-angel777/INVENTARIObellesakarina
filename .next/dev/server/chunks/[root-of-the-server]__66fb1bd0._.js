...
async function GET() {
    try {
        const products = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].productos.findMany({
            orderBy: {
                fecha_creacion: 'desc'
            }
        });
...
async function POST(request) {
    try {
        ...
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].productos.create({
            data: {
                nombre: body.nombre,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__66fb1bd0._.js.map